...
export default function Card_8() {
    const [favClick, setFavClick] = useState(true);
    return (
        <>
            <Card sx={{ width: 160, height: 160, borderRadius:4, marginLeft:1  }}>
                <CardMedia
                    component="img"
                    height="160"
                    image={require('../Pictures/8.png')}
                    alt="asdas"
                />
                <Box sx={{
                ...
                <Box sx={{
                    ...
                    <Chip label="EXCLUSİVE" color="primary" sx={{ height: 26, fontSize: 12 }} />
                    {
                        favClick ?
